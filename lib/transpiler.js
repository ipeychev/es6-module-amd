...
Transpiler.prototype = {
     ...
     *
     * @param {string} root The root of the transpiled file.
     * @param {string} file The file which should be transpiled.
     * @return {object} The converted to AMD file and the generated source map.
     */
    transpile: function(root, file) {
        ...
        ast = this._wrapModule(ast, root, file);
     ...
     * @param {string} root The root of the transpiled file.
     * @param {string} file The name of the transpiled file.
     * @return {object} The wrapped AST.
     */
    _addAMDWrapper: function(ast, root, file) {
        ...
        var moduleName = file.substring(root.length + 1);
     ...
     */
    _wrapModule: function(ast, root, file) {
        ast = this._addModuleVariables(ast);

        ast = this._addAMDWrapper(ast, root, file);
