...
program
    ...
    .option('-r, --root [root folder]', 'The root folder, from which we should start looking for files', String, curDir)
    .option('-o, --output [output folder]', 'Output file to store the generated AMD module.', String, curDir)
    .option('-e, --extensions [output folder]', 'Output file to store the generated AMD module.', list, ['js'])
    .version('0.0.1')
    .parse(process.argv);
